<div class="container-fluid bg-dark text-white-50 py-2 px-0 d-none d-lg-block">
  ...
  <!-- Navbar Start -->
  <nav class="navbar navbar-expand-lg d-flex  navbar-light sticky-top px-4 px-lg-5" style="background-color: #3E4898;">
      ...
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu bg-light border-0 m-0">
            <a href="feature.html" class="dropdown-item">Seinor Assist</a>
            <a href="appointment.html" class="dropdown-item">Child Assist</a>
            <a href="team.html" class="dropdown-item">Home Assist</a>
          </div>
        </div>
